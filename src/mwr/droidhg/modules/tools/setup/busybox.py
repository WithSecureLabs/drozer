...
Typically, you require root access to the device to install Busybox. Mercury can install it from its restrictive context. You can then use $BB in the shell to use it."""
    examples = ""
