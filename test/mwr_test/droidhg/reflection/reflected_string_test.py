...
class ReflectedStringTestCase(unittest.TestCase):
    ...
    def testItShouldAddTwoReflectedStrings(self):
        ...
        s2 = reflection.ReflectedString(" World")
    ...
    def testItShouldBeALNum(self):
        assert reflection.ReflectedString("word").isalnum()
        assert reflection.ReflectedString("word2").isalnum()
        assert reflection.ReflectedString("123").isalnum()

    def testItShouldNotBeALNum(self):
        assert not reflection.ReflectedString("Hello!").isalnum()

    def testItShouldBeAlpha(self):
        assert reflection.ReflectedString("word").isalpha()

    def testItShouldNotBeAlpha(self):
        assert not reflection.ReflectedString("word2").isalpha()
        assert not reflection.ReflectedString("123").isalpha()

    def testItShouldBeADigit(self):
        assert reflection.ReflectedString("123").isdigit()

    def testItShouldNotBeADigit(self):
        assert not reflection.ReflectedString("word").isdigit()
        assert not reflection.ReflectedString("word2").isdigit()

    def testItShouldBeLower(self):
        assert reflection.ReflectedString("word").islower()

    def testItShouldNotBeLower(self):
        assert not reflection.ReflectedString("Word").islower()
        assert not reflection.ReflectedString("123").islower()
        assert not reflection.ReflectedString(" ").islower()

    def testItShouldSpace(self):
        assert reflection.ReflectedString(" ").isspace()

    def testItShouldNotBeSpace(self):
        assert not reflection.ReflectedString("word").isspace()
        assert not reflection.ReflectedString("Word").isspace()
        assert not reflection.ReflectedString("123").isspace()
    ...
    def testItShouldLower(self):
        s1 = reflection.ReflectedString("The quick brown fox jumped over the lazy dog.")
    ...
    def testItShouldSplitLines(self):
        s1 = reflection.ReflectedString("The quick brown\nfox jumped over\nthe lazy dog.")
